...
Mobile.tap(findTestObject('Object Repository/Flashsale/android.view.View'), 0)

Mobile.tap(findTestObject('Object Repository/Flashsale/android.widget.Button - Checkout'), 0)

Mobile.setText(findTestObject('Object Repository/Flashsale/android.widget.EditText'), 'Meita Sulistyani', 0)
